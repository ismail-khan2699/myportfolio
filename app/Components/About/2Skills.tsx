    ...
    return (
        <div className='flex flex-col justify-center items-center gap-10 px-5 md:px-10 py-10'>
            ...
            <div className='w-full h-[100vh] max-lg:h-[80vh] max-sm:h-[60vh] max-xs:h-[50vh] relative bg-circularDark flex items-center justify-center rounded-full max-lg:bg-circularDarkLg max-md:bg-circularDarkMd max-sm:bg-circularDarkSm'>
                ...
                <div className='transition-transform max-sm:hidden duration-1000 transform-none opacity-0 cursor-pointer w-max origin-center absolute font-semibold text-black bg-white py-1 px-3 rounded-full lg:py-2 lg:px-4 md:text-sm xs:font-bold' style={{ transform: 'translateX(30vw) translateY(-5vw)' }}>Strapi</div>
                <div className='transition-transform max-sm:hidden duration-1000 transform-none opacity-0 cursor-pointer w-max origin-center absolute font-semibold text-black bg-white py-1 px-3 rounded-full lg:py-2 lg:px-4 md:text-sm xs:font-bold' style={{ transform: 'translateX(-22vw) translateY(18vw)' }}>TailwindCSS</div>
                <div className='transition-transform max-sm:hidden duration-1000 transform-none opacity-0 cursor-pointer w-max origin-center absolute font-semibold text-black bg-white py-1 px-3 rounded-full lg:py-2 lg:px-4 md:text-sm xs:font-bold' style={{ transform: 'translateX(-1vw) translateY(-22vw)' }}>Node js</div>
            </div>
        </div>
    )
}
